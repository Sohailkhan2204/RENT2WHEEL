        ...
        <div className="relative max-w-4xl mx-auto bg-white rounded-[50px] shadow-form p-4 mb-10">
          <form className="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
            <div className="text-left px-4 py-2">
              <label className="text-sm font-medium text-slate-800/90 flex items-center">
                Pickup Location
                <ChevronDownIcon className="h-4 w-4 ml-1" />
              </label>
              <p className="text-slate-400 mt-1">Please select location</p>
            </div>
            <div className="text-left px-4 py-2 border-l">
              ...
              <div className="flex items-center justify-between mt-1">
                <p className="text-slate-400">dd-mm-yyyy</p>
                <CalendarDaysIcon className="h-5 w-5 text-gray-700-light" />
              </div>
            </div>
            <div className="text-left px-4 py-2 border-l">
